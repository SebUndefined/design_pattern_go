...
// linked to Specification pattern

// Scenario: a user on a website can filter articles by several criteria (price, size, color...)
...
// Bad because we have to interfere with something that has been already tested
